...
description: >-
  Launch the StarXelem Avalonia app to produce a screenshot of a specific tab
  for visual verification of UI changes. Use this skill after modifying any
  view (AXAML) or ViewModel affecting the UI, so you can read the resulting
  image and verify the changes look correct.
---
